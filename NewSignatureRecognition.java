	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==save)
		{
			try
			{
				...
				File targetFile = new File("C:\\desktopbackup\\NEWSignatureRecognition\\SignatureDB\\"+tfname.getText()+tid.getText() +".jpeg");
				...
				path="C:\\desktopbackup\\NEWSignatureRecognition\\SignatureDB\\"+tfname.getText()+tid.getText() +".jpeg";
...
class ProcessSampleScan extends JFrame implements WindowListener,ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
	  ...
	  if (g1.getWidth()== g2.getWidth() && g1.getHeight() == g2.getHeight())
		...
		{
		//System.out.println
		JOptionPane.showMessageDialog(this,"can not compare this images");
		}
