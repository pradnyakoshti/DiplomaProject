...
public class NewSignatureRecognition3
{
...
class mainFrame extends JFrame implements WindowListener,ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
		verifyFrame vf=new verifyFrame();
		vf.setVisible(true);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==save)
		{
			try
			{
				...
				File targetFile = new File("F:\\desktopbackup\\NEWSignatureRecognition\\SignatureDB\\"+tfname.getText()+tid.getText() +".jpeg");
				...
				Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
	       		Connection con = DriverManager.getConnection("jdbc:odbc:SignDB", "","");
				...
				path="F:\\desktopbackup\\NEWSignatureRecognition\\SignatureDB\\"+tfname.getText()+tid.getText() +".jpeg";
...
catch(Exception e)
{
	//JOptionPane.showMessageDialog(null,e.getMessage());
		...
		img() throws IOException
		{

			File file1 = new File("uk.jpg");
File file2 = new File("uk1.jpg");

BufferedImage gr1 = ImageIO.read(file1);
BufferedImage gr2 = ImageIO.read(file2);
			int count2=0,count1=0;
			boolean flag=true;

	  if (gr1.getWidth()== gr2.getWidth() && gr1.getHeight() == gr2.getHeight())
		{

			for (int i = 0; i < gr1.getWidth(); i++)
			{
				for (int j = 0; j < gr1.getHeight(); j++)
				{


					int k=gr1.getRGB(i,j);
						int l=gr2.getRGB(i,j);
			...
			if (flag == false)
			{
				JOptionPane.showMessageDialog(this,"Sorry, Images are not same , " + count2 + " wrong pixels found");
			}
			else
			{
					JOptionPane.showMessageDialog(this," Images are same , " + count1 + " same pixels found and " + count2 + " wrong pixels found");
			}
		}
		else
		{
			JOptionPane.showMessageDialog(this,"cisan not compare this images");
		}
